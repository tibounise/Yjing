<?php
	...
	function showArticle($site_title,$navigation_bar_content,$article_title,$article_pubdate,$article_author,$article_content) {
		...
		$content_array = array($site_title,stripslashes($navigation_bar_content),$article_title,$article_pubdate,$article_author,$article_content);
		if ($file != false) {
	...
	function showPage($site_title,$navigation_bar_content,$page_content) {
		...
		$content_array = array($site_title,stripslashes($navigation_bar_content),$page_content);
		if ($file != false) {
